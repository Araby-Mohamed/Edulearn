                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="profile-info">
                                <img src="{{(!empty(auth()->user()->image) ? url('media/images/student/'.auth()->user()->image) : url('media/images/user.png') )}}" alt="" class="img-responsive profile-photo" />
...
@section('content')
    <!-- Basic Information
        ...
        <div class="edit-block">
            <form action="{{url('student/profile/update')}}" method="post" name="basic-info" id="basic-info" class="form-inline">
                @csrf
                <div class="row">
        ...
        <div class="row">
            <div class="form-group col-xs-12">
                ...
                @php $student = \App\Model\Student::where('user_id',auth()->user()->id)->first(); @endphp
                <input type="text" class="form-control input-group-lg" value="{{$student->stdNumber}}" readonly />
            </div>
        </div>
