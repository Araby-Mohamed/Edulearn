...
@section('content')
        ...
        <form method="post" action="{{url('question_bank/store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="content" name="answer" placeholder="Enter Content" required>{{old('content')}}</textarea>
            </div>
            <div class="form-group">
