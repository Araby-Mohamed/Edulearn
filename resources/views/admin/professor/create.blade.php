...
@section('title') Add New Professor @endsection
@section('css')
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-sharp bold uppercase">Add New Professor</span>
        </div>
    </div>
    @include('admin.layouts.message')
    <div class="portlet-body form">
        <form action="{{url('admin/professor')}}" method="post" role="form" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="input-icon margin-top-10">
                        ...
                        <input type="text" class="form-control" placeholder="Professor Degree" value="{{old('pro_degree')}}"  name="pro_degree" maxlength="150">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="-60y" data-date-end-date="-22y">
                        <input type="text" class="form-control" placeholder="Birth Date" name="birthDate" readonly>
