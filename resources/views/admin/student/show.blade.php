...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label style="margin-bottom: 0;color: #666;">Student Code</label>
                        <div class="input-icon margin-top-10">
                            <i class="fa fa-id-badge" aria-hidden="true"></i>
                            <input type="number" class="form-control" value="{{$student->stdNumber}}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="margin-bottom: 0;color: #666;">Age</label>
                        <div class="input-icon margin-top-10">
    ...
    <nav class="quick-nav">
        ...
        <ul>
            <li>
                <a href="{{url('admin/student/'.$user->id.'/edit')}}" class="active">
                    <span>Edit</span>
                    <i class="icon-note"></i>
                </a>
            </li>
